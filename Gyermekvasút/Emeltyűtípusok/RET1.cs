                    ...
                    switch (R1.Allas)
                    {
                        case EmeltyuAllas.Also:
                            ...
                            {//alsó >> felső (lezárt) = egyenes váltó feloldása
                                ...
                                {
                                    if (VK1.Be != null && (SZAKASZOK[3].Vonat == VK1.Be || SZAKASZOK[2].Vonat == VK1.Be || SZAKASZOK[1].Vonat == VK1.Be || SZAKASZOK[0].Vonat == VK1.Be || !ALLOMAS.Vonatok.Contains(VK1.Be)))
                                    ...
                                    else if (VK1.Ki != null && (VK1.Ki == SZAKASZOK[6].Vonat || !ALLOMAS.Vonatok.Contains(VK1.Ki)))
                        ...
                        case EmeltyuAllas.Felso:
                            ...
                            {//felső >> alsó (lezárt) = kitérő váltó feloldása
                                if (B1.Allas == EmeltyuAllas.Also && B2.Allas == EmeltyuAllas.Felso)
                                {
                                    if (VK1.Be != null && (SZAKASZOK[8].Vonat == VK1.Be || SZAKASZOK[7].Vonat == VK1.Be || SZAKASZOK[1].Vonat == VK1.Be || SZAKASZOK[0].Vonat == VK1.Be || !ALLOMAS.Vonatok.Contains(VK1.Be)))
                                    {//BEJÁRAT UTÁNI FELOLDÁS - a vonat már megérkezett, bejárat alapban
                                        emeltyu.Allas = EmeltyuAllas.Also;
                                        VK1.Valto.Lezart = false;
                                        VK1.ProgressBar = 0;
                    ...
                    switch (R2.Allas)
                    {
                        case EmeltyuAllas.Also:
                            ...
                            {//alsó >> felső (lezárt) = egyenes váltó feloldása
                                ...
                                {
                                    if (VK2.Be != null && (SZAKASZOK[3].Vonat == VK2.Be || SZAKASZOK[4].Vonat == VK2.Be || SZAKASZOK[5].Vonat == VK2.Be || SZAKASZOK[6].Vonat == VK2.Be || !ALLOMAS.Vonatok.Contains(VK2.Be)))
                                    {//BEJÁRAT UTÁNI FELOLDÁS - a vonat már megérkezett, bejárat alapban
                                        emeltyu.Allas = EmeltyuAllas.Felso;
                        ...
                        case EmeltyuAllas.Felso:
                            ...
                            {//felső >> alsó (lezárt) = kitérő váltó feloldása
                                if (A1.Allas == EmeltyuAllas.Also && A2.Allas == EmeltyuAllas.Felso)
                                {
                                    if (VK2.Be != null && (SZAKASZOK[8].Vonat == VK2.Be || SZAKASZOK[9].Vonat == VK2.Be || SZAKASZOK[5].Vonat == VK2.Be || SZAKASZOK[6].Vonat == VK2.Be || !ALLOMAS.Vonatok.Contains(VK2.Be)))
                                    {//BEJÁRAT UTÁNI FELOLDÁS - a vonat már megérkezett, bejárat alapban
                                        emeltyu.Allas = EmeltyuAllas.Also;
                                        VK2.Valto.Lezart = false;
                                        VK2.ProgressBar = 0;
